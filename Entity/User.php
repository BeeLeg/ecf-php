...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    /**
     * @ORM\ManyToMany(targetEntity=Competences::class, mappedBy="comp_user")
     */
    private $competences;

    /**
     * @ORM\ManyToMany(targetEntity=Professions::class, mappedBy="prof_user")
     */
    private $professions;
    ...
    public function removeCompetence(Competences $competence): self
    {
        if ($this->competences->removeElement($competence)) {
            $competence->removeCompUser($this);
        }
    ...
    public function removeProfession(Professions $profession): self
    {
        if ($this->professions->removeElement($profession)) {
            $profession->removeProfUser($this);
        }
